...
var sheet_search_productos_1 = require("@/app/(vendedor)/abm/components/sheet-search-productos");
var Items = function () {
    ...
    var getItems = react_1.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var res_1, error_1;
    ...
    return (React.createElement(React.Fragment, null,
        ...
        React.createElement(table_view_1.TableView, { items: items, isLoading: isLoading, addItem: addItemToCart, handleScroll: handleScroll }),
        React.createElement(list_view_1.ListView, { items: items, isLoading: isLoading, addItem: addItemToCart, handleScroll: handleScroll })));
};
