...
var BuildingManagerClient = function () {
    ...
    var _e = react_1.useState(false), isBuildingSelected = _e[0], setIsBuildingSelected = _e[1];
    ...
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "flex justify-between items-center m-4 mb-8" },
            ...
            !isBuildingSelected && (React.createElement(badge_1.Badge, { className: "mt-2 text-[14px]", variant: "destructive" }, "SELECCIONE UNA OBRA ANTES DE EFECTUAR UNA COMPRA"))),
        React.createElement(table_building_1.TableBuilding, { isLoading: isLoading, buildings: buildings, existingBuilding: existingBuilding }),
        React.createElement(list_building_1["default"], { isLoading: isLoading, buildings: buildings, existingBuilding: existingBuilding })));
};
