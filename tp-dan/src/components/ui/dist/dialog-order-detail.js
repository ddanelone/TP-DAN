...
function DialogOrderDetail(_a) {
    var children = _a.children, orderToView = _a.orderToView, orderDetail = _a.orderDetail, isLoading = _a.isLoading;
        ...
        React.createElement(dialog_1.Dialog, { open: open, onOpenChange: setOpen },
            ...
            React.createElement(dialog_1.DialogContent, { className: "max-w-full w-full" },
                ...
                React.createElement("div", { className: "w-full block" },
                    React.createElement(table_detail_order_1.TableOrderDetail, { orderToView: orderToView, orderDetail: orderToView.detalle, isLoading: isLoading })),
