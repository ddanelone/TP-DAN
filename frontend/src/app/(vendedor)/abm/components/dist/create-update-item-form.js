            ...
            React.createElement("form", { onSubmit: handleSubmit(onSubmit) },
                React.createElement("div", { className: "grid gap-2" },
                    ...
                    React.createElement("div", { className: "mb-3" },
                        ...
                        React.createElement(input_1.Input, __assign({}, register("stockActual"), { id: "stockActual", placeholder: "0", step: "1", type: "number" })),
                        React.createElement("p", { className: "form-error" }, (_f = errors.stockActual) === null || _f === void 0 ? void 0 : _f.message)),
                    React.createElement("div", { className: "mb-3" },
                        React.createElement(label_1.Label, { htmlFor: "stockMinimo" }, "Stock M\u00EDnimo"),
                        React.createElement(input_1.Input, __assign({}, register("stockMinimo"), { id: "stockMinimo", placeholder: "0", step: "1", type: "number" })),
