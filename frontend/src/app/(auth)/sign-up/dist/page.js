...
var SignUp = function () {
  return React.createElement(
    ...
    {
      className:
        "flex justify-center items-center md:h-[95vh] md:px-10 lg:px-26",
    },
    React.createElement(
      "div",
      {
        className:
          "container h-[85vh] flex-col justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0",
      },
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          {
            className:
              "mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[450]",
          },
