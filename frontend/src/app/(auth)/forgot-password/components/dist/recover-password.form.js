...
function RecoverPasswordForm() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, auth_1.sendResetEmail(user.email)];
                case 2:
                    _a.sent();
                    react_hot_toast_1["default"].success("Te hemos enviado un correo electrónico para recuperar tu contraseña", { duration: 4000 });
                    router.push("/");
                    return [3 /*break*/, 5];
                case 3:
                    error_1 = _a.sent();
    ...
    return (React.createElement("div", { className: "md:border border-solid border-gray-300 rounded-xl p-10" },
        React.createElement("div", { className: "text-center" },
            React.createElement("h1", { className: "text-2xl font-semibold" }, "Recuperar Contrase\u00F1a"),
            React.createElement("p", { className: "text-sm text-muted-foreground" }, "Te enviaremos un correo para recuperar la contrase\u00F1a")),
