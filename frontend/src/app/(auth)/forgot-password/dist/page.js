...
exports.metadata = {
    ...
    description: "Te enviaremos un correo electrónico con instrucciones para recuperar tu contraseña"
};
var ForgotPassword = function () {
    return (React.createElement("div", { className: "pt-10 lg:p-8 flex items-center md:h-[70vh]" },
